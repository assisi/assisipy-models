...
class SchoolingVisual:
    ...
    def compute_pdf (self):
        ...
        self.pdf_fF ()
        self.pdf_fS ()
#        print self.alpha,  self.sumSolidAngles_Fish, self.beta, self.sumSolidAngles_Spots
...
if __name__ == '__main__':
    ...
    parser.add_argument ('--beta-w',  type = float, help = 'Weight of a spot of interest on a focal fish near a wall', default = BETA_W)
